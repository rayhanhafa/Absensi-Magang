<x-app-layout title="Absensi Peserta Bimbingan">
    <div class="mb-6">
        <h1 class="text-xl font-semibold text-slate-800">Absensi Peserta Bimbingan</h1>
        <p class="text-sm text-slate-500 mt-1">Pantau kehadiran peserta yang Anda bimbing.</p>
    </div>
        ...
        <div class="overflow-x-auto -mx-5">
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-slate-100">
                    ...
                    @empty
                        <tr>
                            <td colspan="6" class="px-5 py-8 text-center text-slate-400">Belum ada data absensi peserta bimbingan.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
